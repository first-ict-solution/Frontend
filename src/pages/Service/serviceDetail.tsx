    ...
    <>
      <div className="max-w-6xl mx-auto px-6 py-12 space-y-12">
        ...
        {(service.proposal || service.features) && (
          <section className="flex flex-col md:flex-row gap-8" data-aos="fade-up">
            {/* Left: Image Slider */}
        ...
        {/* Terms below both */}
        {service.terms && (
          <section data-aos="fade-up" className="mt-8">
        ...
        <div className="text-center" data-aos="fade-up">
          <button
            ...
            className="px-6 mb-20 py-3 bg-[#0067c2] hover:bg-[#1381dcff] text-white font-semibold transition-colors duration-200"
          >
            Contact for Service
          </button>
        </div>
